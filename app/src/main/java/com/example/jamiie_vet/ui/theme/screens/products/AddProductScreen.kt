package com.example.jamiie_vet.ui.theme.screens.products
...
import com.example.jamiie_vet.data.ProductViewModel
...
fun AddProductScreen(navController: NavController) {
    Column(
        ...
        OutlinedTextField(
            ...
            label = { Text(text = " vet Product name *") },
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "vet Product quantity *") },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
        )
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "vet Product price *") },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
        )
